...
export const translations = {
  en: {
    ...
    versions: {
      ...
      macOSInstallTip: "🍎 macOS Installation: If you see \"file is damaged\" or \"cannot verify developer\", open System Settings → Privacy & Security → find and click \"Open Anyway\" button",
  ...
  zh: {
    ...
    versions: {
      ...
      macOSInstallTip: "🍎 macOS 安装提示：如果提示\"文件已损坏\"或\"无法验证开发者\"，请打开 系统设置 → 隐私与安全性 → 找到并点击\"仍要打开\"按钮",
      releaseDate: "发布日期",
      changelog: "更新内容",
      downloadFor: "下载",
